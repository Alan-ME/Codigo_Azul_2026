// ─────────────────────────────────────────────────────────────
// codigo-azul-web/src/components/common/Icono.jsx
// Componente SVG React que replica al 100% el catálogo de App.ui.icono.
// ─────────────────────────────────────────────────────────────

export const ICONOS_PATHS = {
  // Navegación
  dashboard: (
    <>
  ...
  tablero: (
    <>
      ...
      <rect x="14" y="16" width="7" height="4" rx="2" />
    </>
  ),
  pacientes: (
    <>
  ...
  radio: (
    <>
      <path d="M4.9 19.1a12 12 0 0 1 0-14.14" />
      <path d="M7.76 16.24a8 8 0 0 1 0-8.48" />
      <path d="M16.24 7.76a8 8 0 0 1 0 8.48" />
      <path d="M19.1 4.9a12 12 0 0 1 0 14.14" />
...
export default function Icono({ nombre, size = 20, color, style, className }) {
  const body = ICONOS_PATHS[nombre] || ICONOS_PATHS.check;
  return (
    <svg
